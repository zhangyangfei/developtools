...
public abstract class AbstractXmlElementGenerator extends AbstractGenerator {
    ...
    protected XmlElement getBaseColumnListElement() {
        ...
        answer.addAttribute(new Attribute("refid", //$NON-NLS-1$
            introspectedTable.getMyBatis3SqlMapNamespace() + "." + introspectedTable.getBaseColumnListId()));
        return answer;
    }
    ...
    protected XmlElement getBlobColumnListElement() {
        XmlElement answer = new XmlElement("include"); //$NON-NLS-1$
        answer.addAttribute(new Attribute("refid", //$NON-NLS-1$
            introspectedTable.getMyBatis3SqlMapNamespace() + "." + introspectedTable.getBlobColumnListId()));
        return answer;
    }
    ...
    protected XmlElement getExampleIncludeElement() {
        ...
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
            introspectedTable.getMyBatis3SqlMapNamespace() + "." + introspectedTable.getExampleWhereClauseId()));
    ...
    protected XmlElement getUpdateByExampleIncludeElement() {
        ...
        XmlElement includeElement = new XmlElement("include"); //$NON-NLS-1$
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
            introspectedTable.getMyBatis3SqlMapNamespace() + "." + introspectedTable.getMyBatis3UpdateByExampleWhereClauseId()));
        ifElement.addElement(includeElement);
