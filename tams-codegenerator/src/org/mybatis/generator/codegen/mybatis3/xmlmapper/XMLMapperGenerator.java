...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.DeleteByWorkflowIdElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ExampleWhereClauseElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.InsertElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.InsertSelectElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.InsertSelectWorkflowIdElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectAllEffectiveElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.UpdateByWorkflowIdElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.UpdateByWorkflowIdSelectiveElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addSqlAllDataElement(answer);
        addSqlEffectiveElement(answer);
        addSelectByExampleWithBLOBsElement(answer);
        addSelectByExampleWithoutBLOBsElement(answer);
        addSelectByPrimaryKeyElement(answer);
        addDeleteByPrimaryKeyElement(answer);
      
        //workflowid如果存在则生成，否则不生成
        List<IntrospectedColumn> list = introspectedTable.getAllColumns();
        for (IntrospectedColumn in : list) {
            if (in.getActualColumnName().equals("WORKFLOW_ID")) {
                addDeleteByWorkflowIdElement(answer);
                addInsertSelectWorkflowIdElement(answer);
                addUpdateByWorkflowIdSelectiveElement(answer);
                addUpdateByWorkflowIdElement(answer);
    ...
    protected void addSqlAllDataElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateBaseColumnList()) {
            AbstractXmlElementGenerator elementGenerator = new SelectAllEffectiveElementGenerator(
                false);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }

    protected void addSqlEffectiveElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateBaseColumnList()) {
            AbstractXmlElementGenerator elementGenerator = new SelectAllEffectiveElementGenerator(
                true);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
    ...
    protected void addDeleteByWorkflowIdElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new DeleteByWorkflowIdElementGenerator(
            false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    ...
    protected void addInsertSelectElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new InsertSelectElementGenerator(false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }

    protected void addInsertSelectWorkflowIdElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new InsertSelectWorkflowIdElementGenerator(
            false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    ...
    protected void addUpdateByWorkflowIdSelectiveElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new UpdateByWorkflowIdSelectiveElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addUpdateByWorkflowIdElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new UpdateByWorkflowIdElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
