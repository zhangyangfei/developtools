...
import org.mybatis.generator.codegen.ibatis2.dao.elements.DeleteByWorkflowIdMethodGenerator;
...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.InsertSelectMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.InsertSelectWorkflowIdMethodGenerator;
...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.UpdateByWorkflowIdMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.UpdateByWorkflowIdSelectiveMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        String rootInterface = introspectedTable.getTableConfigurationProperty(
        ...
        for (IntrospectedColumn in : list) {
            if (in.getActualColumnName().equals("WORKFLOW_ID")) {
                addDeleteByWorkflowIdMethod(interfaze);
                addUpdateByWorkflowIdSelectiveMethod(interfaze);
                addUpdateByWorkflowIdMethod(interfaze);
                addInsertSelectWorkflowIdMethod(interfaze);
            }
        }
       
        addInsertMethod(interfaze);
        addInsertSelectiveMethod(interfaze);
        addInsertSelectMethod(interfaze);
    ...
    protected void addDeleteByWorkflowIdMethod(Interface interfaze) {
        if (!interfaze.getType().getShortName().endsWith("HisMapper")) {
            AbstractJavaMapperMethodGenerator methodGenerator = new DeleteByWorkflowIdMethodGenerator(
                false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addInsertSelectMethod(Interface interfaze) {
        AbstractJavaMapperMethodGenerator methodGenerator = new InsertSelectMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
    
    protected void addInsertSelectWorkflowIdMethod(Interface interfaze) {
        AbstractJavaMapperMethodGenerator methodGenerator = new InsertSelectWorkflowIdMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
    ...
    protected void addUpdateByWorkflowIdSelectiveMethod(Interface interfaze) {
        if (!interfaze.getType().getShortName().endsWith("HisMapper")) {
            AbstractJavaMapperMethodGenerator methodGenerator = new UpdateByWorkflowIdSelectiveMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    
    protected void addUpdateByWorkflowIdMethod(Interface interfaze) {
        if (!interfaze.getType().getShortName().endsWith("HisMapper")) {
            AbstractJavaMapperMethodGenerator methodGenerator = new UpdateByWorkflowIdMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
