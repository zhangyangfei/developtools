...
import org.mybatis.generator.codegen.ibatis2.dao.elements.InsertHisByBasicInfoMethodGenerator;
...
public class DAOGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addInsertHisByBasicInfoMethod(topLevelClass, interfaze);
    ...
    protected void addInsertHisByBasicInfoMethod(TopLevelClass topLevelClass,
                                            Interface interfaze) {
        if (introspectedTable.getRules().generateInsertSelective()) {
            AbstractDAOElementGenerator methodGenerator = new InsertHisByBasicInfoMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, topLevelClass,
                interfaze);
        }
    }
