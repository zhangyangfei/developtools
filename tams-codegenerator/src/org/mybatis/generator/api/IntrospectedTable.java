...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_MYBATIS3_SQL_PROVIDER_TYPE, ATTR_DELETE_BY_WORKFLOW_ID_STATEMENT_ID
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setDeleteByWorkflowIdStatementId("deleteByWorkflowId"); //$NON-NLS-1$
    ...
    public void setDeleteByWorkflowIdStatementId(String s) {
        internalAttributes.put(
            InternalAttribute.ATTR_DELETE_BY_WORKFLOW_ID_STATEMENT_ID, s);
    }
    ...
    public String getFullyQualifiedTableNameAtRuntime() {
        return getAliasedFullyQualifiedTableNameAtRuntime();
    }

    public String getAliasedFullyQualifiedTableNameAtRuntime() {
        String tableName = internalAttributes
